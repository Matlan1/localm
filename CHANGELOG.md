...
- **Two pulls of the same file started together after a crashed download no longer both take over its leftover lock and write into one `.part` file.** Only one continues; the other reports that the download is already being taken over.
