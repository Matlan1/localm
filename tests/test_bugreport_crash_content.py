...
class TestLogUnavailableIsNotSilence:
    """H4: an empty digest used to mean THREE unrelated things - no log file matched this run, the file was found but could not be READ, and the run genuinely logged nothing notable - and all three rendered as no log section at all."""
