...
"""CHK-COMFY-APIURL: a link-local / cloud-metadata comfy_api_url is refused so an ADMIN-set api_url cannot turn the comfy control calls into an SSRF probe of cloud metadata."""
