...
# --------------------------------------------------------------------------- #
#  #953: a keyless LOCAL process (localm status / the MCP tool) authenticates  #
#  via this instance's own attach token, the same "local process, not a       #
#  browser" distinction /v1/surfaces/gui's mount_gui route already uses.       #
# --------------------------------------------------------------------------- #
