...
"""A CLI `--mmproj` override never persisted to the registry, unlike every other mmproj-discovery path (pull.py's auto-attach, the registry's own recorded field)."""
