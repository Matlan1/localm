...
# --------------------------------------------------------------------- #
#  Restoring a SUPERSEDED (id still live) archive entry - the accepted-      #
#  update-correction path, the one the id-collision-only design missed.      #
# --------------------------------------------------------------------- #
...
# --------------------------------------------------------------------- #
#  _load_forgotten() robustness (mirrors the main record store's and the    #
#  pending-corrections sidecar's corrupt-line handling)                     #
# --------------------------------------------------------------------- #
