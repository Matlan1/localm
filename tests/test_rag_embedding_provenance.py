...
"""FIX4: a collection built the ORDINARY way (add_paths/add_uploads/resync) must record which embedding model built it, not only a collection that went through reembed()."""
