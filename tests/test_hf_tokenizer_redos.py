...
# at N=2000, while Oniguruma is already hung there. 1800 is used for the
# "must be rejected" tests: about 10.4s in Oniguruma against about 0.46s in re,
# both asserted below.
...
def test_dangerous_pre_tokenizer_pattern_is_refused(tmp_path, pattern, reason_substr):
    ...
    # The offending pattern is named AND the reason given, not a generic
