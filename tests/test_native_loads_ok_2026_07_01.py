...
"""CHK-SETUP-NOBACKEND regression: setup-llama's load-test must report a FAILED provision when the native runtime LOADS but registers ZERO compute backends."""
