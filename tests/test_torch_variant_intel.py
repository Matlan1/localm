...
"""Intel HF torch routing: a vendor-neutral runtime pick (vulkan/own) on an Intel box must route the optional HuggingFace PyTorch to the native XPU wheels, not skip Intel. (Before: Intel fell through to 'none' - the dropped-Intel bug.) The backend pick still fully drives the variant for explicit vendor..."""
