...
# --------------------------------------------------------------------------- #
#  Core: a cold collection gets backfilled correctly (both directions from    #
#  test_rag_peek_stats.py, applied to the backfilled cache specifically)      #
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
#  HTTP routes: the Collection-level tests above prove load_and_maybe_backfill #
#  is correct in isolation; these prove rag_collections()/rag_detail() (the   #
#  two call sites this feature exists for) actually route through it and that #
#  the write lands on the real on-disk collection the routes themselves serve #
#  from, not just some object constructed and discarded mid-request.          #
# --------------------------------------------------------------------------- #
