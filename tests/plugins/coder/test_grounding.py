...
"""B7: the coder agent would answer questions about the project from assumption (hallucinating files / APIs that do not exist) instead of reading the code first."""
