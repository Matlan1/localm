...
def home(tmp_path, monkeypatch):
    """Throwaway LOCALM_HOME wired through both the lazy home_dir() and the import-frozen config module attrs, so load_config() and managed_comfy path resolution agree on the same tmp dir (see 'Test home isolation (import-time)')."""
    h = tmp_path / ".localm"
