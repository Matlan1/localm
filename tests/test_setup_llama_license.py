...
"""S4: setup-llama must ship the upstream MIT license text alongside the bundled llama.cpp/ggml binaries. _copy_binaries copied only .dll/.exe/.so/.dylib and discarded the archive's LICENSE; now it captures the license (or a bundled MIT fallback) into the runtime lib/."""
