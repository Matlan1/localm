...
export function buildSettingControl(field) {
  ...
  switch (field.widget) {
    ...
    case "secret": {
      ...
      if (isEnv) {
        ...
        input.placeholder = notSetPlaceholder;
      }
  ...
  } else if (secretClearBtn) {
    const row = el("div", "dir-picker-row secret-row");
    row.append(input, secretClearBtn);
    wrap.appendChild(row);
  } else {
